...
public class StringTransformations implements Transformations {
	...
	private StringBuilder extensions;
	...
	public StringTransformations(String base) {
		...
		this.extensions = new StringBuilder();
	...
	public void define(String key, String value) {
		extensions.append("#define ").append(key).append(" ").append(value).append("\n");
	}
	...
	public void replaceExact(String from, String to) {
		...
		extensions = new StringBuilder(extensions.toString().replace(from, to));
	...
	public void replaceRegex(String regex, String to) {
		...
		extensions = new StringBuilder(extensions.toString().replaceAll(regex, to));
